<div class="border-end border-warning h-100">
    <div class="text-center">
        <img src="{{asset('images/pic-1.jpg')}}" alt="" class="img-fluid rounded-circle mt-5" >
  <h3 class="text-white mt-3 st-font">Unknown</h3>
    </div>
<nav class="nav flex-column text-center m-4">
